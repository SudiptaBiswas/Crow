 ...
 */
class ElectricBCMat : public DerivativeMaterialInterface<Material> {
public:
...
protected:
  ...
  const Function &_left_func;
  const Function &_right_func;
  const Function &_top_func;
  const Function &_bottom_func;
  MooseEnum _bc_type;
