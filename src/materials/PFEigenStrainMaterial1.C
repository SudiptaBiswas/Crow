...
registerMooseObject("CrowApp", PFEigenStrainMaterial1);

template <> InputParameters validParams<PFEigenStrainMaterial1>() {
...
PFEigenStrainMaterial1::PFEigenStrainMaterial1(
    const InputParameters &parameters)
    : ComputeVariableEigenstrain(parameters), _c(coupledValue("c")),
      _e_v(getParam<Real>("e_v")), _epsilon0(getParam<Real>("epsilon0")),
...
void PFEigenStrainMaterial1::computeEigenStrain() {
  ...
  // _delastic_strain_dc[_qp].addIa(-_epsilon0); // delastic_strain/dc =
  // -deigenstrain/dc
